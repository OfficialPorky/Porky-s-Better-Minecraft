...
public class XostriumOreBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:xostrium_ore")
	public static final Block block = null;
	public XostriumOreBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 427);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("xostrium_ore", "xostrium_ore", blockAt -> {
