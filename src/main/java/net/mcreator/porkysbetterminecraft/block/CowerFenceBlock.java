...
public class CowerFenceBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:cower_fence")
	public static final Block block = null;
	public CowerFenceBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 302);
	}
