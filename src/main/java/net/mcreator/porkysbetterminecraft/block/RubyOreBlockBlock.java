...
public class RubyOreBlockBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:ruby_ore_block")
	public static final Block block = null;
	public RubyOreBlockBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 34);
	}
