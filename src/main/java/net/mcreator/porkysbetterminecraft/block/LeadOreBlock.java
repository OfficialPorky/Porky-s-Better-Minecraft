...
public class LeadOreBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:lead_ore")
	public static final Block block = null;
	public LeadOreBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 211);
	}
