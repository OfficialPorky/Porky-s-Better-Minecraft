...
public class CowerStairsBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:cower_stairs")
	public static final Block block = null;
	public CowerStairsBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 300);
	}
