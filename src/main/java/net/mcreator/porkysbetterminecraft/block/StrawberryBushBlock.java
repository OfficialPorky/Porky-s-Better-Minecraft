...
import net.mcreator.porkysbetterminecraft.item.StrawberryItem;
...
public class StrawberryBushBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:strawberry_bush")
	public static final Block block = null;
	public StrawberryBushBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 315);
	}
