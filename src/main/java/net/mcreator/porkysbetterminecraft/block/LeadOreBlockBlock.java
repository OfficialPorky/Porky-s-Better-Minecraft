...
public class LeadOreBlockBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:lead_ore_block")
	public static final Block block = null;
	public LeadOreBlockBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 212);
	}
