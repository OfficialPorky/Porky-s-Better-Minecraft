...
import net.mcreator.porkysbetterminecraft.item.TomatoItem;
...
public class TomatoPlantBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:tomato_plant")
	public static final Block block = null;
	public TomatoPlantBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 320);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TomatoItem.block, (int) (3)));
		}
