...
public class PorkerFenceBlock extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:porker_fence")
	public static final Block block = null;
	public PorkerFenceBlock(PorkysBetterminecraftModElements instance) {
		super(instance, 286);
	}
