...
public class CampsiteNeutralStructure extends PorkysBetterminecraftModElements.ModElement {
	public CampsiteNeutralStructure(PorkysBetterminecraftModElements instance) {
		super(instance, 584);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 2000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("porkys_betterminecraft", "campsite_neutral"));
						if (template == null)
							return false;
