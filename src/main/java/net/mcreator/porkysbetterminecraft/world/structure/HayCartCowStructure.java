...
public class HayCartCowStructure extends PorkysBetterminecraftModElements.ModElement {
	public HayCartCowStructure(PorkysBetterminecraftModElements instance) {
		super(instance, 586);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 5000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("porkys_betterminecraft", "hay_cart_cow"));
						if (template == null)
							return false;
