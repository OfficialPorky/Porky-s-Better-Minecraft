...
import net.mcreator.porkysbetterminecraft.item.AetherItem;
...
public class AetherDimension extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:aether")
	public static final ModDimension dimension = null;
	@ObjectHolder("porkys_betterminecraft:aether_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public AetherDimension(PorkysBetterminecraftModElements instance) {
		super(instance, 471);
	...
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("porkys_betterminecraft:aether")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("porkys_betterminecraft:aether"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("porkys_betterminecraft:aether"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("porkys_betterminecraft:aether_biome")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new AetherItem().setRegistryName("aether"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = AetherDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "aether_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = AetherDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
