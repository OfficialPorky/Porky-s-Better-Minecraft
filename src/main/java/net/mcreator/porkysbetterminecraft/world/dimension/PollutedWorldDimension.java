...
import net.mcreator.porkysbetterminecraft.item.PollutedWorldItem;
...
public class PollutedWorldDimension extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:polluted_world")
	public static final ModDimension dimension = null;
	@ObjectHolder("porkys_betterminecraft:polluted_world_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public PollutedWorldDimension(PorkysBetterminecraftModElements instance) {
		super(instance, 222);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("polluted_world"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("porkys_betterminecraft:polluted_world")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("porkys_betterminecraft:polluted_world"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("porkys_betterminecraft:polluted_world"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("porkys_betterminecraft:wasteland")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new PollutedWorldItem().setRegistryName("polluted_world"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("polluted_world_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = PollutedWorldDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("polluted_world_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "polluted_world_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = PollutedWorldDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
