...
public class CowPresidentEntity extends PorkysBetterminecraftModElements.ModElement {
	public static EntityType entity = null;
	public CowPresidentEntity(PorkysBetterminecraftModElements instance) {
		super(instance, 231);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("cow_president")
						.setRegistryName("cow_president");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10066330, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("cow_president_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("porkys_betterminecraft:textures/cowpresident.png");
				}
			};
