...
public class DisarmEnchantment extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:disarm")
	public static final Enchantment enchantment = null;
	public DisarmEnchantment(PorkysBetterminecraftModElements instance) {
		super(instance, 507);
	}
