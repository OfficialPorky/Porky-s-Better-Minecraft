...
public class IceAspectEnchantment extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:ice_aspect")
	public static final Enchantment enchantment = null;
	public IceAspectEnchantment(PorkysBetterminecraftModElements instance) {
		super(instance, 487);
	}
