...
public class AutoRifleItem extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:auto_rifle")
	public static final Item block = null;
	@ObjectHolder("porkys_betterminecraft:entitybulletauto_rifle")
	public static final EntityType arrow = null;
	public AutoRifleItem(PorkysBetterminecraftModElements instance) {
		super(instance, 197);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletauto_rifle").setRegistryName("entitybulletauto_rifle"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(1158));
			setRegistryName("auto_rifle");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 7f, 8, 5);
