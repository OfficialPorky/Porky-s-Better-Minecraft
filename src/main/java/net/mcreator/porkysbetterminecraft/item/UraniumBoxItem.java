...
import net.mcreator.porkysbetterminecraft.gui.UraniumBoxGUIGui;
...
public class UraniumBoxItem extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:uranium_box")
	public static final Item block = null;
	public UraniumBoxItem(PorkysBetterminecraftModElements instance) {
		super(instance, 241);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof UraniumBoxGUIGui.GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Uranium Box");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new UraniumBoxGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
