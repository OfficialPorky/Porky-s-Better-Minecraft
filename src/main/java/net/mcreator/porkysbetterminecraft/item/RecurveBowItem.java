...
public class RecurveBowItem extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:recurve_bow")
	public static final Item block = null;
	@ObjectHolder("porkys_betterminecraft:entitybulletrecurve_bow")
	public static final EntityType arrow = null;
	public RecurveBowItem(PorkysBetterminecraftModElements instance) {
		super(instance, 160);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletrecurve_bow").setRegistryName("entitybulletrecurve_bow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(423));
			setRegistryName("recurve_bow");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 4.5, 1);
