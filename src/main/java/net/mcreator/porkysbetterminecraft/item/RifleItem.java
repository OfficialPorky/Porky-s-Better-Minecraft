...
public class RifleItem extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:rifle")
	public static final Item block = null;
	@ObjectHolder("porkys_betterminecraft:entitybulletrifle")
	public static final EntityType arrow = null;
	public RifleItem(PorkysBetterminecraftModElements instance) {
		super(instance, 194);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(815));
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 7f, 7, 4);
