...
import net.mcreator.porkysbetterminecraft.gui.PlasticBagGUIGui;
...
public class PlasticBagItem extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:plastic_bag")
	public static final Item block = null;
	public PlasticBagItem(PorkysBetterminecraftModElements instance) {
		super(instance, 401);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PlasticBagGUIGui.GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Plastic Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PlasticBagGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
