...
public class PistolItem extends PorkysBetterminecraftModElements.ModElement {
	@ObjectHolder("porkys_betterminecraft:pistol")
	public static final Item block = null;
	@ObjectHolder("porkys_betterminecraft:entitybulletpistol")
	public static final EntityType arrow = null;
	public PistolItem(PorkysBetterminecraftModElements instance) {
		super(instance, 193);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(960));
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 7, 2);
